    ...
    <div style={{backgroundColor: '#0b0b14', color: '#e0d7f5', minHeight: '100vh', fontFamily: "'Segoe UI', sans-serif"}}>
      <section className="hero" style={{position: 'relative', textAlign: 'center', color: 'white'}}>
        <img
          ...
          alt=""
        />
        <div className="overlay" style={{position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, display: 'flex', flexDirection: 'column', justifyContent: 'space-between', padding: '2rem'}}>
          <h2 style={{fontSize: '3rem', margin: 0, color: '#d1b3ff'}}>The DreamWalker Gallery</h2>
          <p style={{fontSize: '1.2rem', maxWidth: 600, margin: '0 auto', color: '#f0eaff'}}>
